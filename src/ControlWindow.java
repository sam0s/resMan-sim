...
public class ControlWindow extends Window {
	...
	public ControlWindow(int sizex, int sizey, int x, int y, int padx, int pady, double weight, Font f, StateGame s) throws NoSuchMethodException, SecurityException {
		...
		dad_name = new Label(0, set_dad.rely + set_dad.sizey + pady, 2, 2, 0, "Dad: NULL", StateGame.f_18);
		...
		mom_name = new Label(set_mom.relx, set_mom.rely + set_dad.sizey + pady, 2, 2, 0, "Mom: NULL", StateGame.f_18);
		...
		add_container(new Button(120, 32, 150, newGuy.rely + newGuy.sizey + pady, 2, "sub health", StateGame.f_24, fgetMethod("sub_health"), this));
